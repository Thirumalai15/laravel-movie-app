<div class="mt-8">
    <a href="{{ route('movie.show', $movie['id']) }}">
        <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$movie['poster_path'] }}"  alt="poster" class="rounded-lg hover:opacity-75 object-center transition ease-in-out duration-150"/>
    </a>
    <div class="mt-2">
